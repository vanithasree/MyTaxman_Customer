...
struct CustomerProfileBase : Codable {
    let code : String?
    let desc : [CustomerProfileDesc]?
    ...
    init(from decoder: Decoder) throws {
        ...
        desc = try values.decodeIfPresent([CustomerProfileDesc].self, forKey: .desc)
    }
    
}

struct CustomerProfileDesc : Codable {
